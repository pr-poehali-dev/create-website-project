...
const translations = {
  en: {
    ...
    'page.about.story.title': 'Our Story',
    'page.about.story.paragraph1': 'Founded in Hong Kong, ECOL emerged from the vision to bridge cutting-edge Chinese technology innovation with global enterprise needs.',
    'page.about.story.paragraph2': 'Our team of experts combines deep technical knowledge with international business understanding, delivering solutions that scale globally.',
    'page.about.story.paragraph3': 'Today, we serve clients worldwide, providing AI and cryptographic solutions that drive digital transformation.',
    'page.about.vision.title': 'Our Vision',
    'page.about.vision.description': 'To be the leading provider of AI and cryptographic solutions, connecting global markets with cutting-edge innovation.',

    'page.services.cta.title': 'Ready to Transform Your Business?',
    'page.services.cta.description': 'Join hundreds of companies that trust ECOL for their digital transformation journey.',
    'page.services.cta.button': 'Get Started Today',

    'page.team.join.title': 'Join Our Team',
    'page.team.join.description': 'Be part of our mission to revolutionize AI and cryptographic solutions globally.',
    'page.team.join.button': 'View Open Positions',

    'page.contact.form.name': 'Full Name',
    'page.contact.form.namePlaceholder': 'Enter your full name',
    'page.contact.form.emailPlaceholder': 'Enter your email',
    'page.contact.form.subject': 'Subject',
    'page.contact.form.subjectPlaceholder': 'What can we help you with?',
    'page.contact.form.submit': 'Send Message',
    'page.contact.methods.title': 'Get In Touch',
    'page.contact.methods.email.title': 'Email Us',
    'page.contact.methods.email.description': 'Send us an email anytime',
    'page.contact.methods.phone.title': 'Call Us',
    'page.contact.methods.phone.description': '24/7 support available',
    'page.contact.methods.address.title': 'Visit Us',
    'page.contact.methods.address.description': 'Our Hong Kong headquarters',
    'page.contact.methods.address.value': 'Central, Hong Kong SAR',
    'page.contact.methods.hours.title': 'Business Hours',
    'page.contact.methods.hours.description': 'Monday to Friday',
    'page.contact.methods.hours.value': '9:00 AM - 6:00 PM HKT',
    'page.contact.map.title': 'Find Us',
    'page.contact.map.placeholder': 'Interactive map will be displayed here',
  ...
  ru: {
    ...
    // Page-specific content
    'page.about.story.title': 'Наша история',
    'page.about.story.paragraph1': 'Основанная в Гонконге, ECOL возникла из видения соединить передовые китайские технологические инновации с потребностями мирового предприятий.',
    'page.about.story.paragraph2': 'Наша команда экспертов сочетает глубокие технические знания с пониманием международного бизнеса, предоставляя решения глобального масштаба.',
    'page.about.story.paragraph3': 'Сегодня мы обслуживаем клиентов по всему миру, предоставляя решения в области ИИ и криптографии, которые способствуют цифровой трансформации.',
    'page.about.vision.title': 'Наше видение',
    'page.about.vision.description': 'Стать ведущим поставщиком решений в области ИИ и криптографии, соединяя глобальные рынки с передовыми инновациями.',

    'page.services.cta.title': 'Готовы трансформировать свой бизнес?',
    'page.services.cta.description': 'Присоединяйтесь к сотням компаний, которые доверяют ECOL свой путь цифровой трансформации.',
    'page.services.cta.button': 'Начать сегодня',

    'page.team.join.title': 'Присоединяйтесь к нашей команде',
    'page.team.join.description': 'Станьте частью нашей миссии по революционизации решений ИИ и криптографии глобально.',
    'page.team.join.button': 'Посмотреть открытые позиции',

    'home.features.title': 'Почему выбирают ECOL',
    'home.features.subtitle': 'Лидируя в будущем с инновациями ИИ и криптографии',
    'home.features.ai.title': 'Превосходство в ИИ',
    'home.features.ai.description': 'Передовые решения ИИ на базе новейших технологий машинного обучения',
    'home.features.security.title': 'Криптографическая безопасность',
    'home.features.security.description': 'Корпоративная безопасность с продвинутыми криптографическими реализациями',
    'home.features.global.title': 'Глобальный охват',
    'home.features.global.description': 'Обслуживание клиентов по всему миру с местной экспертизой и глобальными стандартами',
    'home.cta.title': 'Готовы начать?',
    'home.cta.description': 'Присоединяйтесь к тысячам компаний, которые доверяют ECOL свою цифровую трансформацию.',
    'home.cta.services': 'Изучить услуги',
    ...
    'footer.description': 'Ведущий поставщик решений ИИ и криптографии из Гонконга, обслуживающий клиентов по всему миру.',
    ...
    'footer.address': 'Центральный, Гонконг САР',
  ...
  zh: {
    ...
    // Page-specific content  
    'page.about.story.title': '我们的故事',
    'page.about.story.paragraph1': '成立于香港，ECOL 源于将尖端中国技术创新与全球企业需求相结合的愿景。',
    'page.about.story.paragraph2': '我们的专家团队将深厚的技术知识与国际商业理解相结合，提供全球规模的解决方案。',
    'page.about.story.paragraph3': '如今，我们为全世界的客户提供服务，提供推动数字化转型的 AI 和密码学解决方案。',
    'page.about.vision.title': '我们的愿景',
    'page.about.vision.description': '成为 AI 和密码学解决方案的领先提供商，连接全球市场与尖端创新。',

    'page.services.cta.title': '准备好转变您的业务了吗？',
    'page.services.cta.description': '加入数百家信任 ECOL 进行数字化转型之旅的公司。',
    'page.services.cta.button': '今天开始',

    'page.team.join.title': '加入我们的团队',
    'page.team.join.description': '成为我们全球革新 AI 和密码学解决方案使命的一部分。',
    'page.team.join.button': '查看空缺职位',

    'home.features.title': '为什么选择 ECOL',
    'home.features.subtitle': '用 AI 和密码学创新引领未来',
    'home.features.ai.title': 'AI 卓越',
    'home.features.ai.description': '由最新机器学习技术驱动的尖端 AI 解决方案',
    'home.features.security.title': '密码学安全',
    'home.features.security.description': '具有先进密码学实施的企业级安全',
    'home.features.global.title': '全球覆盖',
    'home.features.global.description': '以本地专业知识和全球标准为全世界客户提供服务',
    'home.cta.title': '准备开始了吗？',
    'home.cta.description': '加入数千家信任 ECOL 进行数字化转型的公司。',
    'home.cta.services': '探索服务',
    ...
    'footer.company': '公司',
    'footer.legal': '法律',
    'footer.description': '总部位于香港的领先 AI 和密码学解决方案提供商，为全球客户提供服务。',
